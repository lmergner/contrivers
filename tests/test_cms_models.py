...
from contrivers.core.errors import ModelError
...
class PasswordTestCase(unittest.TestCase):
    ...
    def test_hashing(self):
        with mock.patch('contrivers.cms.models.pass_context') as pass_ctx:
    ...
    def test_verified(self):
        """ Test that `contrivers.cms.models.Editor.verify_password` calls `passlib.CryptContext.verify_and_update` """
        with mock.patch('contrivers.cms.models.pass_context') as pass_ctx:
    ...
    def test_verify_and_update(self):
        with mock.patch('contrivers.cms.models.pass_context') as pass_ctx:
            ...
            with mock.patch('contrivers.cms.models.datetime_with_timezone') as MockTime:
